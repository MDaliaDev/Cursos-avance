...
function toggleCard(card) {
    ...
    const allCards = document.querySelectorAll('.safety-card');
    allCards.forEach(c => {
        if (c !== card) {
...
// Auto-open first card after animations
function autoOpenFirstCard() {
    setTimeout(() => {
        const firstCard = document.querySelector('.safety-card');
        if (firstCard) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add click effect to image
    const forkliftImage = document.querySelector('.forklift-image');
    if (forkliftImage) {
        forkliftImage.addEventListener('click', function() {
